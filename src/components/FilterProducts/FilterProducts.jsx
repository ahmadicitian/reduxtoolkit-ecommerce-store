...
import {
    ...
    filterBySize,
    sortByPrice
} from "../../features/slices/productSlice.js";
const FilterProducts = () => {
    ...
    return (
        <div>
            <div className="pt-16">
                <div className="pl-14">
                    <h1 className="text-gray-600 text-4xl font-inter font-bold tracking-normal leading-none mb-8 text-left">
                        {type}
                    </h1>
                    ...
                    {error ? (<Error></Error>)
                        : (
                            <div className="grid grid-cols-4 md:grid-cols-2 sm:grid-cols-1 justify-items-center py-8 gap-12">
